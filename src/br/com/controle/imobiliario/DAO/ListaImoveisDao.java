...
public class ListaImoveisDao {

	private Connection connection;

	public ListaImoveisDao() {
	...
	public void listar() {
		...
		String sql = "SELECT * FROM imoveis WHERE usuario = '" + principal.tfusuarioprincipal.getText() + "' order by codimovel";
		...
		for (Imoveis temp : dados) {
			Object[] linha = { temp.getCodigo(), temp.getEmpreendimento(), temp.getDescricao(),
					temp.getSequencial(), temp.getValorimovel() };
			tab.addRow(linha);
