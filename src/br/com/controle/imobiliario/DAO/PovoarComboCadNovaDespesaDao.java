...
public class PovoarComboCadNovaDespesaDao {
	
	private Connection connection;

	public PovoarComboCadNovaDespesaDao() {
	...
	public void listar() {
		...
		String sql = "SELECT DISTINCT descricao FROM imoveis WHERE empreendimento = '"+CadastrarDespesa.cbcadnovadespesaempreendimento.getSelectedItem()+"' ORDER BY descricao ASC";
		...
		try {
			...
			while (rs.next()) {
				...
				CadastrarDespesa.cbcadnovadespesaunidade.addItem(rs.getString("descricao"));
