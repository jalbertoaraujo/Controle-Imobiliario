...
public class PovoarComboCadNovaReceitaEmpreendimentoDao {
	
	private Connection connection;

	public PovoarComboCadNovaReceitaEmpreendimentoDao() {
	...
	public void listar() {
		...
		try {
			...
			while (rs.next()) {
				...
				CadastrarReceita.cbcadnovareceitaempreendimento.addItem(rs.getString("empreendimento"));
