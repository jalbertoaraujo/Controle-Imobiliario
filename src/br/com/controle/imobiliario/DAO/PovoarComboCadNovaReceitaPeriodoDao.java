...
public class PovoarComboCadNovaReceitaPeriodoDao {
	
	private Connection connection;

	public PovoarComboCadNovaReceitaPeriodoDao() {
	...
	public void listar() {
		...
		String sql = "SELECT DISTINCT descricao FROM imoveis WHERE empreendimento = '"+InfImoveisReceitaGeralImovel.cbcadnovareceitaempreendimentoperiodo.getSelectedItem()+"' ORDER BY descricao ASC";
		...
		try {
			...
			while (rs.next()) {
				...
				InfImoveisReceitaGeralImovel.cbcadnovareceitaperiodo.addItem(rs.getString("descricao"));
