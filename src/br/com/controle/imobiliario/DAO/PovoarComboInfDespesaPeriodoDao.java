...
public class PovoarComboInfDespesaPeriodoDao {

	private Connection connection;

	public PovoarComboInfDespesaPeriodoDao() {
	...
	public void listar() {
		...
		try {
			...
			//	InfImoveisDespesaAnual.cbperiodoinfimoveisdespesaperiodo.addItem(rs.getString("periodo"));
