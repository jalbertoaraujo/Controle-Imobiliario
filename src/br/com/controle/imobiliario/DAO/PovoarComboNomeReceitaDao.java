...
public class PovoarComboNomeReceitaDao {
	
	private Connection connection;

	public PovoarComboNomeReceitaDao() {
	...
	public void listar() {
		...
		CadastrarReceita.cbnomereceita.removeAllItems();

		String sql = "SELECT DISTINCT descricao FROM descreceita order by descricao asc ";
		...
		try {
			...
			while (rs.next()) {
				...
				CadastrarReceita.cbnomereceita.addItem(rs.getString("descricao"));
