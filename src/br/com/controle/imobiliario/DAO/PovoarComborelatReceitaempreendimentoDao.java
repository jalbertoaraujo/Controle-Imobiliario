...
public class PovoarComborelatReceitaempreendimentoDao {
	
	private Connection connection;

	public PovoarComborelatReceitaempreendimentoDao() {
	...
	public void listar() {
		...
		try {
			...
			while (rs.next()) {
				...
				RelatorioReceitaporEmpreendimento.cbrelatreceitaempreendimento.addItem(rs.getString("empreendimento"));
