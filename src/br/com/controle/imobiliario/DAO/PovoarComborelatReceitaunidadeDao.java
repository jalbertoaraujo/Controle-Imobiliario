...
public class PovoarComborelatReceitaunidadeDao {
	
	private Connection connection;

	public PovoarComborelatReceitaunidadeDao() {
	...
	public void listar() {
		...
		String sql = "SELECT distinct descricao FROM imoveis where empreendimento = '"+RelatorioReceitaporEmpreendimento.cbrelatreceitaempreendimento.getSelectedItem()+"' ";
		...
		try {
			...
			while (rs.next()) {
				...
				RelatorioReceitaporEmpreendimento.cbrelatreceitaunidade.addItem(rs.getString("descricao"));
