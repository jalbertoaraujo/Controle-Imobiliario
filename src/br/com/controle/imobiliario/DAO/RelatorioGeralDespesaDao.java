...
public class RelatorioGeralDespesaDao {

	private Connection connection;

	public RelatorioGeralDespesaDao() {

		this.connection = new ConnectionFactory().getConnection();
	}

	public void relatoriogeraldespesa() {

		List<Imoveis> dados = new ArrayList<Imoveis>();

		String sql = "SELECT * FROM despesa order by unidade asc";
		...
		try {
			...
			JasperPrint jp = JasperFillManager.fillReport("Ireport/DespesaGeral.jasper", new HashMap(), jrrs);
