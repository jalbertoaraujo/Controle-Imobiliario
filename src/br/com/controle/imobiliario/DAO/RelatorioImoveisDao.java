...
public class RelatorioImoveisDao {

	private Connection connection;

	public RelatorioImoveisDao() {

		this.connection = new ConnectionFactory().getConnection();
	}

	public void relatorioimoveiscadastrados() {
		...
		try {
			...
			JasperPrint jp = JasperFillManager.fillReport("Ireport/imoveiscadastrados.jasper", new HashMap(), jrrs);
