...
public class AlterarDespesa extends JFrame {

	private JPanel contentPane;
	public static JTextField tfvalordespesa;
	public static JTextField tfobsdespesa;
	public static JComboBox cbnomedespesaalterar;
	public static JComboBox cbcompetenciadespesa;
	public static JTextField tfiddespesaalterar;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AlterarDespesa frame = new AlterarDespesa();
	...
	public AlterarDespesa() {
		...
		setIconImage(Toolkit.getDefaultToolkit()
				.getImage(AlterarDespesa.class.getResource("/br/com/controle/imobiliario/imagem/Logo CI.png")));
		setResizable(false);
		...
		JButton btinserirdespesa = new JButton("<html><center>ALTERAR<br/>DESPESA</center></html>");
		...
		btinserirdespesa.addActionListener(new ActionListener() {
			...
			AlterarDespesaDao add = new AlterarDespesaDao();
			add.listar();
		...
		tfvalordespesa.setBounds(106, 76, 283, 20);
		...
		tfobsdespesa.setBounds(106, 130, 283, 20);
		tfobsdespesa.setDocument(new UpperCaseDocument());
		panel.add(tfobsdespesa);

		cbnomedespesaalterar = new JComboBox();
		cbnomedespesaalterar.setFont(new Font("Tahoma", Font.BOLD, 14));
		cbnomedespesaalterar.setBounds(105, 49, 286, 20);
		panel.add(cbnomedespesaalterar);
		...
		tfiddespesaalterar = new JTextField();
		tfiddespesaalterar.setFont(new Font("Tahoma", Font.BOLD, 14));
		tfiddespesaalterar.setEditable(false);
		tfiddespesaalterar.setBounds(106, 23, 86, 20);
		panel.add(tfiddespesaalterar);
		tfiddespesaalterar.setColumns(10);
		...
		lblNewLabel.setIcon(
				new ImageIcon(AlterarDespesa.class.getResource("/br/com/controle/imobiliario/imagem/download.jpg")));
...
//		pccnd.listar();
		PovoarComboNomeDespesaAlterarDao pcnd = new PovoarComboNomeDespesaAlterarDao();
		pcnd.listar();
